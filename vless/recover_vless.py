...
for server in servers:
    ...
    restore_command = f"sshpass -p '{password}' ssh -o StrictHostKeyChecking=no -p {port} {username}@{host} 'cd ~/domains/11.spfnas.us.kg/serv00-script/vless && chmod +x check_vless.sh && ./check_vless.sh'"
    try:
